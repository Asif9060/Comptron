    ...
    return (
        <div className="w-full px-4 lg:px-6 xl:px-8">
            <div className="flex flex-wrap items-center justify-center md:justify-around lg:justify-between gap-4">
                ...
                <p className="text-xl z-20 text-white font-bold sm:text-2xl md:text-4xl lg:text-3xl xl:text-5xl 2xl:text-6xl lg:translate-x-[100px] 2xl:translate-x-[330px] text-center md:text-left">
                <ColourfulText text="Comptron" /> <span className="text-[#483D68]" >- Creativity Assembled</span> <br />
                </p>

    
                <div className="text-[#00ACF2] font-bold text-xl clock sm:text-2xl md:text-3xl lg:text-2xl xl:text-3xl 2xl:text-4xl md:translate-x-0 md:translate-y-0 lg:ml-auto"  style={{ fontFamily: 'Arial, sans-serif', fontSize: '2rem', textAlign: 'center' }}>
                {formatTime(time)}
                </div>
            </div>
        </div>
