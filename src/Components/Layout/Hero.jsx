      ...
      <section className="relative h-screen w-full bg-cover bg-center overflow-hidden">
         ...
         <div className="absolute inset-0 w-full h-full z-0">
            <video
               ...
               src={
                  "https://res.cloudinary.com/dkv9ksobc/video/upload/v1752083817/Bg_osge7c.mp4"
               }></video>
         </div>
         ...
         <div
            ...
            <div className="flex items-center gap-4">
                           ...
                           <MenuItem>
                              {() => (
                                 <button
                                    ...
                                    className="w-full text-left cursor-pointer px-4 py-2 text-red-600 hover:bg-red-50 transition-colors flex items-center gap-2">
                                    <svg
                                       className="w-4 h-4"
                                       fill="none"
                                       stroke="currentColor"
               ...
               <button
                  className="w-10 h-10 flex items-center cursor-pointer justify-center rounded-full bg-white z-30 shadow-lg hover:bg-blue-100 transition-colors duration-300"
         ...
         <div className="sm:hidden absolute top-0 left-0 w-full flex justify-between items-center px-4 py-3 z-30">
            ...
            <div className="flex items-center gap-3">
               {user ? (
                  <Menu as="div" className="relative">
                     <div>
                        <MenuButton className="relative w-10 h-10 top-0.5 rounded-full overflow-hidden hover:ring-2 hover:ring-blue-400 transition-all duration-300">
                           <img
                              src={
                                 customUser?.image ||
                                 user?.photoURL ||
         ...
         <div
            ...
            <button
               className="absolute top-6 cursor-pointer right-6 w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 hover:bg-gray-700 transition-colors"
         ...
         <div className="relative z-10 flex flex-col justify-center items-center text-white text-center h-full px-4 sm:px-6 max-w-4xl mx-auto">
            <div className="space-y-6 sm:space-y-8">
               ...
               <p className="text-base sm:text-[19px] opacity-0 animate-[fadeIn_0.8s_forwards_0.3s] max-w-md sm:max-w-[50rem] mx-auto leading-relaxed">
                  Unlock Your Potential with Comptron. <br /> The official computer club
                  of North Western University, driven by the passion of our CSE faculty
                  and students. <br /> At Comptron, it&apos;s where Creativity Assembled.
               </p>
