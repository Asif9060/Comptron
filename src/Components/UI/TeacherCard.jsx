      ...
      <div className="flex justify-center">
         <div className="card">
            ...
            <div className="profile-pic">
               <a href={props.cont.profile}>
                  <img src={props.cont["img"]} alt="" />
               </a>
            </div>

            <div className="bottom">
               <div className="content">
                  <a href={props.cont.profile} className="name">
                     {props.cont["name"]}
                  </a>
