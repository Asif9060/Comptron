      ...
      <div className="w-full h-screen">
         ...
         <div className="flex translate-y-[5rem] flex-col mb-[5rem] items-center justify-center">
            <p className=" flex vision text-center text-black text-2xl  w-[70rem]">
               ...
               problem-solving, empowering students across all disciplines to harness the
               power of computing, artificial intelligence, and advanced engineering to
               drive meaningful advancements in academia, industry, and society.
            </p>
            <br />
            <br />
            <p className="flex mission text-center text-2xl text-black w-[70rem]">
               ...
               environment where students develop problem-solving skills, computational
               expertise, and research-driven innovation. Through competitive programming,
               interdisciplinary collaboration, cutting-edge research, and participation
               in global technology competitions, we aim to bridge the gap between theory
               and real-world application, equipping future leaders with the knowledge and
               technical proficiency to shape the future of computing and engineering.
            </p>
         </div>
