      ...
      >
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Manage pending user registrations, approve or reject applicants, and help maintain the quality of our platform.
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center bg-gray-900/80 px-4 py-2 rounded-lg border border-gray-700/50">
              <span className="text-sm font-medium mr-2 text-gray-400">Pending:</span>
              <span className="text-lg font-bold text-blue-400">{pendingUsers.length}</span>
              {isFiltering && (
                <>
                  <span className="mx-2 text-gray-600">|</span>
                  <span className="text-sm font-medium mr-2 text-gray-400">Filtered:</span>
                  <span className="text-lg font-bold text-purple-400">{filteredUsers.length}</span>
                </>
              )}
            </div>
          </div>
                        ...
                        <div className="flex items-center flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center">
                              ...
                              <span className="ml-2 px-2 py-1 bg-yellow-500/20 rounded-full text-xs text-yellow-300 font-medium">Pending</span>
                            </div>
                          ...
                          <div className="p-6 bg-gray-800/30">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex items-start">
                                    <span className="text-gray-400 w-24 flex-shrink-0">Gender:</span>
                                    <span className="text-white">{user.gender || "Not specified"}</span>
                                  </div>
                                  {user.studentId && (
                                    <div className="flex items-start">
                                      <span className="text-gray-400 w-24 flex-shrink-0">Student ID:</span>
                                      <span className="text-white">{user.studentId}</span>
                                    </div>
                                  )}
                                  {user.bloodGroup && (
                                    <div className="flex items-start">
                                      <span className="text-gray-400 w-24 flex-shrink-0">Blood Group:</span>
                                      <span className="text-white">{user.bloodGroup}</span>
                                    </div>
                                  )}
                                  {user.dateOfBirth && (
                                    <div className="flex items-start">
                                      <span className="text-gray-400 w-24 flex-shrink-0">Birth Date:</span>
                                      <span className="text-white">{format(new Date(user.dateOfBirth), 'MMMM d, yyyy')}</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                            ...
                            <div className="mt-4 bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                              ...
                              <div className="flex flex-wrap gap-x-6 gap-y-2">
                                <div className="flex items-start">
                                  <span className="text-gray-400 w-32 flex-shrink-0">Firebase ID:</span>
                                  <code className="text-green-400 bg-gray-900/50 px-2 py-1 rounded text-xs font-mono">{user.firebaseUserId?.substring(0, 12)}...</code>
                                </div>
                                <div className="flex items-start">
                                  <span className="text-gray-400 w-32 flex-shrink-0">Registration:</span>
                                  <span className="text-white">{user.createdAt && format(new Date(user.createdAt), 'PPpp')}</span>
                                </div>
                              </div>
                            </div>
                          </div>
