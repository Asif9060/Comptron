          ...
          <>
            ...
            >
              ...
              >
                ...
                <div className="absolute right-10 bottom-8 text-6xl opacity-10 group-hover:opacity-20 transition-opacity duration-300">👥</div>
                <h2 className="text-xl font-medium text-blue-300 mb-2">Total Users</h2>
              ...
              <motion.div
                className={`relative overflow-hidden backdrop-blur-md ${stats.pendingUsers > 0 ? 'bg-yellow-500/20' : 'bg-white/10'} p-8 rounded-xl shadow-xl border ${stats.pendingUsers > 0 ? 'border-yellow-500/50' : 'border-white/10'} group hover:shadow-2xl transition-all duration-300`}
                variants={itemVariants}
              ...
              >
                ...
                <div className="flex items-center">
                  <h2 className="text-xl font-medium text-yellow-300 mb-2">Pending Approvals</h2>
            ...
            <motion.div
              ...
              variants={containerVariants}
            >
              <h2 className="text-3xl font-bold mb-8 text-gray-200 pl-2">Admin Actions</h2>
