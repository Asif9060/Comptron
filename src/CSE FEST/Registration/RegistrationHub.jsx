                  ...
                  <motion.div
                     ...
                     {eventRegistrations.map((event, index) => (
                        <motion.button
                           ...
                           className={`group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-7 text-left transition-all duration-500 hover:-translate-y-2 hover:border-white/30 hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F6A623]/70 cursor-pointer ${
