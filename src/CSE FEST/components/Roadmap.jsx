      ...
      <div className="min-h-screen bg-[#1c1535] text-white">
         ...
         <div className="mx-auto px-4 py-16">
            <div className="text-center mb-12">
               <h1 className="text-4xl md:text-5xl rdtxt font-bold text-[#F6A623] mb-4">
                  Event Roadmap
               </h1>
            ...
            <div className="relative">
               {/* Vertical line */}
               <div className="absolute left-1/2 transform -translate-x-1/2 w-1.5 h-full bg-gradient-to-b from-transparent via-[#F6A623] to-transparent"></div>
               ...
               {mainEvents.map((event, index) => (
                  <div
                     ...
                     {/* Timeline dot */}
                     <div
                        className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-[#F6A623] rounded-full border-4 border-[#1c1535] z-10 animate-pulse transition-shadow duration-300"
                        style={{
                           boxShadow:
                        ...
                        <div
                           ...
                           <div className="relative h-40 overflow-hidden">
                              ...
                              <div className="absolute inset-0 bg-[#F6A623]/0 group-hover:bg-[#F6A623]/10 transition-colors duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                                 <div className="bg-[#F6A623] text-[#1c1535] px-3 py-1 rounded-full text-sm font-medium">
                           ...
                           {/* Event Content */}
                           <div className="p-6">
                              <div className="flex items-center text-xs text-[#F6A623] mb-3">
                                 <svg
                              ...
                              <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-[#F6A623] transition-colors duration-300">
                                 {event.title}
                              </h3>
                              ...
                              <button
                                 ...
                                 className="w-full bg-[#F6A623] hover:bg-[#e0951f] text-[#1c1535] font-medium py-2 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center cursor-pointer">
