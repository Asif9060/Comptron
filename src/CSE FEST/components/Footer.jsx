const Footer = () => {
   return (
      <footer className="bg-[#1c1535] text-white re border-t border-[#F6A623]/30">
               ...
               <div className="space-y-6">
                  <div className="flex items-center justify-start">
                     <div className="relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-[#F6A623] to-orange-500 rounded-xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-300"></div>
                        <div className="relative bg-gradient-to-br from-[#1c1535] to-[#2a1f4a] p-2 rounded-xl border-2 border-[#F6A623]/40 group-hover:border-[#F6A623] transition-all duration-300 shadow-lg">
                           <img
                              src="logos/fest.png"
               ...
               <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                     <div className="flex items-start space-x-3">
                        ...
                        <span className="text-gray-300">comptron@nwu.ac.bd</span>
                     </div>
                     <div className="flex items-start space-x-3">
                        <svg
                           className="w-5 h-5 text-[#F6A623] mt-0.5"
                        ...
                        <span className="text-gray-300">+880 1400874851</span>
                     </div>
                     <div className="flex items-start space-x-3">
                        <svg
                           className="w-5 h-5 text-[#F6A623] mt-0.5"
                  ...
                  <div className="space-y-4">
                     ...
                     <div className="border-l-4 border-[#F6A623] pl-4">
                        ...
                        <div className="font-medium text-white">
                           NWU Building-2 Campus
                        </div>
                     </div>
                     <div className="border-l-4 border-[#F6A623] pl-4">
                        <div className="text-sm text-[#F6A623]">Duration:</div>
                        <div className="font-medium text-white">2 Day Event</div>
                     </div>
                  </div>
               </div>
            </div>
