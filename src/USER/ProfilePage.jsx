...
import female from "../assets/images/female2.jpg";
const ProfilePage = () => {
  const { id } = useParams();
  ...
  return (
    <div className=" text-white font-[Poppins] h-screen flex justify-center items-start px-5 py-10">
      {/* Sidebar */}
      <div
      ...
      {/* Main Content */}
      <div className="w-full max-w-4xl rounded-3xl shadow-lg p-10">
        {error && (
        ...
        {user && (
          <div className="bg-[#1e1e1e]  w-[70rem] rounded-3xl shadow-lg p-10">
            {user.image ? (
              <img
                src={user.image}
                alt="Profile"
            ...
            <div className="flex flex-wrap gap-6 mb-10">
              <div className="flex-1 min-w-[280px] bg-[#2a2a2a] rounded-2xl p-6">
                ...
                <ul className=" list-inside text-center space-y-2 text-base text-gray-200">
