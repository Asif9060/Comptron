...
const ProfilePage = () => {
  ...
  useEffect(() => {
    if (user && qrCodeRef.current) {
      ...
      QRCode.toCanvas(qrCodeRef.current, profileUrl, {
        width: 144,
        margin: 4,
        color: {
          dark: '#000000',
        ...
        if (qrHolder) {
          ...
          if (existingCanvas) {
            ...
            await new Promise((resolve) => {
              QRCode.toCanvas(tempCanvas, profileUrl, {
                width: 144,
                margin: 4,
                color: {
                  dark: '#000000',
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `block px-4 py-3 rounded-lg transition-colors duration-200 flex items-center ${
                  isActive ? "bg-gradient-to-r from-blue-600 to-blue-500" : "hover:bg-gray-800 hover:text-blue-400"
                }`
              }
          ...
          <div className="bg-[#1A1A1A] resp w-full layer shadow-xl rounded-3xl p-4 sm:p-6 md:p-10 overflow-y-auto pt-12 md:pt-4 border border-gray-800/50">
            <div className="relative w-full mb-8">
              ...
              <div className="flex flex-col items-center relative">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-center bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">{user.name}</h1>
                <p className="text-blue-400 text-center mb-1 text-sm sm:text-base">{user.bio}</p>
                <p className="font-mono text-blue-400 text-center mb-2 text-sm sm:text-base">{user.customId}</p>
                <p
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 mb-10">
              <div className="flex-1 min-w-[250px] bg-[#202020] rounded-2xl p-6 border border-gray-800/50 hover:border-blue-500/30 transition-all duration-300 shadow-lg hover:shadow-blue-900/10 group">
                <h2 className="text-lg sm:text-xl text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300 font-semibold mb-4 flex items-center gap-2">
                  <svg className="w-5 h-5 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" clipRule="evenodd" />
                  </svg>
                  Skills
                </h2>
                {user.skills && typeof user.skills === "string" ? (
                  <ul className="text-white list-disc ml-5 space-y-2 text-sm sm:text-base">
                    {user.skills.split(",").map((skill, index) => (
                      <li key={index} className="text-gray-300 hover:text-white transition-colors duration-300">{skill.trim()}</li>
                    ))}
                  </ul>
                ) : Array.isArray(user.skills) && user.skills.length > 0 ? (
                  <ul className="text-white space-y-2 text-sm sm:text-base">
                    {user.skills.map((skill, index) => (
                      <li key={index} className="text-gray-300 hover:text-white transition-colors duration-300">{skill}</li>
                    ))}
                  </ul>
                ) : (
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    {user.portfolio && (
                      ...
                      >
                        ...
                        <span className="text-sm text-gray-300 group-hover:text-white transition-colors duration-300">Portfolio</span>
                      </a>
                    )}
                    ...
                    {user.cv && (
                      ...
                      >
                        ...
                        <span className="text-sm text-gray-300 group-hover:text-white transition-colors duration-300">CV / Resume</span>
                      </a>
                    )}
                  </div>
                )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-[#1A1A1A] rounded-xl p-4 flex items-center gap-3 hover:bg-[#1E1E1E] transition-colors duration-300">
                  ...
                  <div className="overflow-hidden">
                    ...
                    <p className="text-white text-sm font-medium truncate">{user.email || "Not provided"}</p>
                  </div>
                </div>
                
                <div className="bg-[#1A1A1A] rounded-xl p-4 flex items-center gap-3 hover:bg-[#1E1E1E] transition-colors duration-300">
                  <div className="bg-green-500/10 p-3 rounded-lg">
                    <svg className="w-6 h-6 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                  </div>
                  <div>
